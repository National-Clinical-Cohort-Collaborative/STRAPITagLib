								...
								<strapi:tenantResearcherEssentialsDomainBlockLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="tenantResearcherEssentialId" name="tenantResearcherEssentialId" size="40" value="<strapi:tenantResearcherEssentialsDomainBlockLinksTenantResearcherEssentialId />">
											<br>

											<label for="contentImageBlockLeftId">ContentImageBlockLeftId</label>
											<input type="text" id="contentImageBlockLeftId" name="contentImageBlockLeftId" size="40" value="<strapi:tenantResearcherEssentialsDomainBlockLinksContentImageBlockLeftId />">
											<br>
