                        ...
                        <div class="col-xs-8">
								<form action="add.jsp" method="post" >
									<fieldset>
										...
										<input type="text" id="requestHeader" name="requestHeader" size="40" value="">
										<br>

										<label for="requestBlock">RequestBlock</label>
										<input type="text" id="requestBlock" name="requestBlock" size="40" value="">
										<br>

										<label for="overviewHeader">OverviewHeader</label>
										<input type="text" id="overviewHeader" name="overviewHeader" size="40" value="">
										<br>

										<label for="overviewBlock">OverviewBlock</label>
										<input type="text" id="overviewBlock" name="overviewBlock" size="40" value="">
										<br>

										<label for="processHeader">ProcessHeader</label>
										<input type="text" id="processHeader" name="processHeader" size="40" value="">
										<br>

										<label for="prereqHeader">PrereqHeader</label>
										<input type="text" id="prereqHeader" name="prereqHeader" size="40" value="">
										<br>

										<label for="prereqBlock">PrereqBlock</label>
										<input type="text" id="prereqBlock" name="prereqBlock" size="40" value="">
										<br>
										...
										<input type="text" id="submitBlock" name="submitBlock" size="40" value="">
										<br>
										...
										<input type="text" id="submitBlock3" name="submitBlock3" size="40" value="">
										<br>
