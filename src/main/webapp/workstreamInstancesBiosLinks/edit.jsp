								...
								<strapi:workstreamInstancesBiosLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="workstreamInstanceId" name="workstreamInstanceId" size="40" value="<strapi:workstreamInstancesBiosLinksWorkstreamInstanceId />">
											<br>

											<label for="bioId">BioId</label>
											<input type="text" id="bioId" name="bioId" size="40" value="<strapi:workstreamInstancesBiosLinksBioId />">
											<br>

											<label for="bioOrder">BioOrder</label>
											<input type="text" id="bioOrder" name="bioOrder" size="40" value="<strapi:workstreamInstancesBiosLinksBioOrder />">
											<br>
