...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:faqListsEnclaveFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>FaqListsEnclaveFaqsLinks</legend>
											...
											<input type="text" id="faqListId" name="faqListId" size="40" value="<strapi:faqListsEnclaveFaqsLinksFaqListId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:faqListsEnclaveFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:faqListsEnclaveFaqsLinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:faqListsEnclaveFaqsLinks ID="${ID}">
			<strapi:faqListsEnclaveFaqsLinksFaqListId faqListId = "${param.faqListId}" />
			<strapi:faqListsEnclaveFaqsLinksFaqId faqId = "${param.faqId}" />
			<strapi:faqListsEnclaveFaqsLinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:faqListsEnclaveFaqsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
