								...
								<strapi:biosBioGroupsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="bioId" name="bioId" size="40" value="<strapi:biosBioGroupsLinksBioId />">
											<br>

											<label for="bioGroupId">BioGroupId</label>
											<input type="text" id="bioGroupId" name="bioGroupId" size="40" value="<strapi:biosBioGroupsLinksBioGroupId />">
											<br>

											<label for="bioGroupOrder">BioGroupOrder</label>
											<input type="text" id="bioGroupOrder" name="bioGroupOrder" size="40" value="<strapi:biosBioGroupsLinksBioGroupOrder />">
											<br>

											<label for="bioOrder">BioOrder</label>
											<input type="text" id="bioOrder" name="bioOrder" size="40" value="<strapi:biosBioGroupsLinksBioOrder />">
											<br>
