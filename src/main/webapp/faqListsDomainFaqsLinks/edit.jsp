...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:faqListsDomainFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>FaqListsDomainFaqsLinks</legend>
											...
											<input type="text" id="faqListId" name="faqListId" size="40" value="<strapi:faqListsDomainFaqsLinksFaqListId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:faqListsDomainFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:faqListsDomainFaqsLinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:faqListsDomainFaqsLinks ID="${ID}">
			<strapi:faqListsDomainFaqsLinksFaqListId faqListId = "${param.faqListId}" />
			<strapi:faqListsDomainFaqsLinksFaqId faqId = "${param.faqId}" />
			<strapi:faqListsDomainFaqsLinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:faqListsDomainFaqsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
