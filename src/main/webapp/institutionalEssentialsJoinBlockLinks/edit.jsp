...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:institutionalEssentialsJoinBlockLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>InstitutionalEssentialsJoinBlockLinks</legend>
											...
											<input type="text" id="institutionalEssentialId" name="institutionalEssentialId" size="40" value="<strapi:institutionalEssentialsJoinBlockLinksInstitutionalEssentialId />">
											<br>

											<label for="contentImageBlockLeftId">ContentImageBlockLeftId</label>
											<input type="text" id="contentImageBlockLeftId" name="contentImageBlockLeftId" size="40" value="<strapi:institutionalEssentialsJoinBlockLinksContentImageBlockLeftId />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:institutionalEssentialsJoinBlockLinks ID="${ID}">
			<strapi:institutionalEssentialsJoinBlockLinksInstitutionalEssentialId institutionalEssentialId = "${param.institutionalEssentialId}" />
			<strapi:institutionalEssentialsJoinBlockLinksContentImageBlockLeftId contentImageBlockLeftId = "${param.contentImageBlockLeftId}" />
		</strapi:institutionalEssentialsJoinBlockLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
