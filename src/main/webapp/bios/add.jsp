                        ...
                        <div class="col-xs-8">
								<form action="add.jsp" method="post" >
									<fieldset>
										...
										<input type="text" id="organization" name="organization" size="40" value="">
										<br>

										<label for="organizationUrl">OrganizationUrl</label>
										<input type="text" id="organizationUrl" name="organizationUrl" size="40" value="">
										<br>

										<label for="website">Website</label>
										<input type="text" id="website" name="website" size="40" value="">
										<br>

										<label for="orcid">Orcid</label>
										<input type="text" id="orcid" name="orcid" size="40" value="">
										<br>
