...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:domainsDomainTeamsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>DomainsDomainTeamsLinks</legend>
											...
											<input type="text" id="domainId" name="domainId" size="40" value="<strapi:domainsDomainTeamsLinksDomainId />">
											<br>

											<label for="domainTeamId">DomainTeamId</label>
											<input type="text" id="domainTeamId" name="domainTeamId" size="40" value="<strapi:domainsDomainTeamsLinksDomainTeamId />">
											<br>

											<label for="domainTeamOrder">DomainTeamOrder</label>
											<input type="text" id="domainTeamOrder" name="domainTeamOrder" size="40" value="<strapi:domainsDomainTeamsLinksDomainTeamOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:domainsDomainTeamsLinks ID="${ID}">
			<strapi:domainsDomainTeamsLinksDomainId domainId = "${param.domainId}" />
			<strapi:domainsDomainTeamsLinksDomainTeamId domainTeamId = "${param.domainTeamId}" />
			<strapi:domainsDomainTeamsLinksDomainTeamOrder domainTeamOrder = "${param.domainTeamOrder}" />
		</strapi:domainsDomainTeamsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
