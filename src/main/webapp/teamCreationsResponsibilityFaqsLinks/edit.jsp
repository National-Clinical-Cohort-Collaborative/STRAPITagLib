...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:teamCreationsResponsibilityFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>TeamCreationsResponsibilityFaqsLinks</legend>
											...
											<input type="text" id="teamCreationId" name="teamCreationId" size="40" value="<strapi:teamCreationsResponsibilityFaqsLinksTeamCreationId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:teamCreationsResponsibilityFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:teamCreationsResponsibilityFaqsLinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:teamCreationsResponsibilityFaqsLinks ID="${ID}">
			<strapi:teamCreationsResponsibilityFaqsLinksTeamCreationId teamCreationId = "${param.teamCreationId}" />
			<strapi:teamCreationsResponsibilityFaqsLinksFaqId faqId = "${param.faqId}" />
			<strapi:teamCreationsResponsibilityFaqsLinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:teamCreationsResponsibilityFaqsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
