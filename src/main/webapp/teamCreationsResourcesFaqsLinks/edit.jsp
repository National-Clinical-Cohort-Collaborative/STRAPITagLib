...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:teamCreationsResourcesFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>TeamCreationsResourcesFaqsLinks</legend>
											...
											<input type="text" id="teamCreationId" name="teamCreationId" size="40" value="<strapi:teamCreationsResourcesFaqsLinksTeamCreationId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:teamCreationsResourcesFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:teamCreationsResourcesFaqsLinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:teamCreationsResourcesFaqsLinks ID="${ID}">
			<strapi:teamCreationsResourcesFaqsLinksTeamCreationId teamCreationId = "${param.teamCreationId}" />
			<strapi:teamCreationsResourcesFaqsLinksFaqId faqId = "${param.faqId}" />
			<strapi:teamCreationsResourcesFaqsLinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:teamCreationsResourcesFaqsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
