...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:publicationReviewsFaqs2Links ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>PublicationReviewsFaqs2Links</legend>
											...
											<input type="text" id="publicationReviewId" name="publicationReviewId" size="40" value="<strapi:publicationReviewsFaqs2LinksPublicationReviewId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:publicationReviewsFaqs2LinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:publicationReviewsFaqs2LinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:publicationReviewsFaqs2Links ID="${ID}">
			<strapi:publicationReviewsFaqs2LinksPublicationReviewId publicationReviewId = "${param.publicationReviewId}" />
			<strapi:publicationReviewsFaqs2LinksFaqId faqId = "${param.faqId}" />
			<strapi:publicationReviewsFaqs2LinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:publicationReviewsFaqs2Links>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
