                        ...
                        <div class="col-xs-8">
								<form action="add.jsp" method="post" >
									<fieldset>
										...
										<input type="text" id="grantCite" name="grantCite" size="40" value="">
										<br>

										<label for="credits">Credits</label>
										<input type="text" id="credits" name="credits" size="40" value="">
										<br>

										<label for="signup">Signup</label>
										<input type="text" id="signup" name="signup" size="40" value="">
										<br>

										<label for="social">Social</label>
										<input type="text" id="social" name="social" size="40" value="">
										<br>
