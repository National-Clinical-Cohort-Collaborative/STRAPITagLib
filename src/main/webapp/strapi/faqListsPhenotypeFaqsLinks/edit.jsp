...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:faqListsPhenotypeFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>FaqListsPhenotypeFaqsLinks</legend>
											...
											<input type="text" id="faqListId" name="faqListId" size="40" value="<strapi:faqListsPhenotypeFaqsLinksFaqListId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:faqListsPhenotypeFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:faqListsPhenotypeFaqsLinksFaqOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:faqListsPhenotypeFaqsLinks ID="${ID}">
			<strapi:faqListsPhenotypeFaqsLinksFaqListId faqListId = "${param.faqListId}" />
			<strapi:faqListsPhenotypeFaqsLinksFaqId faqId = "${param.faqId}" />
			<strapi:faqListsPhenotypeFaqsLinksFaqOrder faqOrder = "${param.faqOrder}" />
		</strapi:faqListsPhenotypeFaqsLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
