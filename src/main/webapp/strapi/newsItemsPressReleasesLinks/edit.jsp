...
<c:choose>
								...
								<strapi:newsItemsPressReleasesLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="newsItemId" name="newsItemId" size="40" value="<strapi:newsItemsPressReleasesLinksNewsItemId />">
											<br>

											<label for="pressReleaseId">PressReleaseId</label>
											<input type="text" id="pressReleaseId" name="pressReleaseId" size="40" value="<strapi:newsItemsPressReleasesLinksPressReleaseId />">
											<br>

											<label for="pressReleaseOrder">PressReleaseOrder</label>
											<input type="text" id="pressReleaseOrder" name="pressReleaseOrder" size="40" value="<strapi:newsItemsPressReleasesLinksPressReleaseOrder />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		<fmt:parseNumber var="ID" value="${param.ID}" />
		<fmt:parseNumber var="newsItemId" value="${param.newsItemId}" />
		<fmt:parseNumber var="pressReleaseId" value="${param.pressReleaseId}" />
		<strapi:newsItemsPressReleasesLinks ID="${ID}">
