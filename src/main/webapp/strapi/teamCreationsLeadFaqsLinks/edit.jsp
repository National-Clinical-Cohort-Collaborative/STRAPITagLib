								...
								<strapi:teamCreationsLeadFaqsLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="teamCreationId" name="teamCreationId" size="40" value="<strapi:teamCreationsLeadFaqsLinksTeamCreationId />">
											<br>

											<label for="faqId">FaqId</label>
											<input type="text" id="faqId" name="faqId" size="40" value="<strapi:teamCreationsLeadFaqsLinksFaqId />">
											<br>

											<label for="faqOrder">FaqOrder</label>
											<input type="text" id="faqOrder" name="faqOrder" size="40" value="<strapi:teamCreationsLeadFaqsLinksFaqOrder />">
											<br>
