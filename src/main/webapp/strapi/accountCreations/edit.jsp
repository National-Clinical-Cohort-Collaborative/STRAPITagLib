								...
								<strapi:accountCreations ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="beforeStartingHeader" name="beforeStartingHeader" size="40" value="<strapi:accountCreationsBeforeStartingHeader />">
											<br>

											<label for="beforeStartingBlock">BeforeStartingBlock</label>
											<input type="text" id="beforeStartingBlock" name="beforeStartingBlock" size="40" value="<strapi:accountCreationsBeforeStartingBlock />">
											<br>
