								...
								<strapi:researcherEssentialsJoinBlockLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="researcherEssentialId" name="researcherEssentialId" size="40" value="<strapi:researcherEssentialsJoinBlockLinksResearcherEssentialId />">
											<br>

											<label for="contentImageBlockLeftId">ContentImageBlockLeftId</label>
											<input type="text" id="contentImageBlockLeftId" name="contentImageBlockLeftId" size="40" value="<strapi:researcherEssentialsJoinBlockLinksContentImageBlockLeftId />">
											<br>
