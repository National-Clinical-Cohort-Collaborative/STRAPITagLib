...
<c:choose>
                        ...
                        <div class="col-xs-8">
								...
								<strapi:researcherEssentialsGovernanceBlockLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											<legend>ResearcherEssentialsGovernanceBlockLinks</legend>
											...
											<input type="text" id="researcherEssentialId" name="researcherEssentialId" size="40" value="<strapi:researcherEssentialsGovernanceBlockLinksResearcherEssentialId />">
											<br>

											<label for="contentImageBlockRightId">ContentImageBlockRightId</label>
											<input type="text" id="contentImageBlockRightId" name="contentImageBlockRightId" size="40" value="<strapi:researcherEssentialsGovernanceBlockLinksContentImageBlockRightId />">
											<br>
	...
	<c:when test="${param.submit eq 'Save'}">
		...
		<strapi:researcherEssentialsGovernanceBlockLinks ID="${ID}">
			<strapi:researcherEssentialsGovernanceBlockLinksResearcherEssentialId researcherEssentialId = "${param.researcherEssentialId}" />
			<strapi:researcherEssentialsGovernanceBlockLinksContentImageBlockRightId contentImageBlockRightId = "${param.contentImageBlockRightId}" />
		</strapi:researcherEssentialsGovernanceBlockLinks>
		<c:redirect url="list.jsp" />
	</c:when>
	<c:otherwise>
