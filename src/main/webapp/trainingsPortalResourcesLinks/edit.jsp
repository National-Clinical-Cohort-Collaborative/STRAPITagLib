								...
								<strapi:trainingsPortalResourcesLinks ID="${ID}">
									<form action="edit.jsp" method="post" >
										<fieldset>
											...
											<input type="text" id="trainingId" name="trainingId" size="40" value="<strapi:trainingsPortalResourcesLinksTrainingId />">
											<br>

											<label for="resourceId">ResourceId</label>
											<input type="text" id="resourceId" name="resourceId" size="40" value="<strapi:trainingsPortalResourcesLinksResourceId />">
											<br>

											<label for="resourceOrder">ResourceOrder</label>
											<input type="text" id="resourceOrder" name="resourceOrder" size="40" value="<strapi:trainingsPortalResourcesLinksResourceOrder />">
											<br>
