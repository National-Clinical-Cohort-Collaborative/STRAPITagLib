...
public class DomainsUpdatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(DomainsUpdatedAtToNow.class);


	public int doStartTag() throws JspException {
		try {
			Domains theDomains = (Domains)findAncestorWithClass(this, Domains.class);
			theDomains.setUpdatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing Domains for updatedAt tag ");
