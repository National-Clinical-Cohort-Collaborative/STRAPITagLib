...
public class ResearcherEssentialsCreatedAt extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(ResearcherEssentialsCreatedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			if (!theResearcherEssentials.commitNeeded) {
				pageContext.getOut().print(theResearcherEssentials.getCreatedAt());
			}
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing ResearcherEssentials for createdAt tag ");
	...
	public void setCreatedAt(Timestamp createdAt) throws JspException {
		try {
			ResearcherEssentials theResearcherEssentials = (ResearcherEssentials)findAncestorWithClass(this, ResearcherEssentials.class);
			theResearcherEssentials.setCreatedAt(createdAt);
		} catch (Exception e) {
			log.error("Can't find enclosing ResearcherEssentials for createdAt tag ", e);
			freeConnection();
			Tag parent = getParent();
