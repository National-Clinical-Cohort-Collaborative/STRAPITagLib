...
public class ResearcherEssentialsUpdatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(ResearcherEssentialsUpdatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theResearcherEssentials.setUpdatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing ResearcherEssentials for updatedAt tag ");
