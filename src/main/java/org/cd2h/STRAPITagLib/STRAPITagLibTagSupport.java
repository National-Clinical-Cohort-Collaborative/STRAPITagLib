...
public class STRAPITagLibTagSupport extends TagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;
    private static final Logger log = LogManager.getLogger(STRAPITagLibTagSupport.class);

    public STRAPITagLibTagSupport() {
        super();
    }
