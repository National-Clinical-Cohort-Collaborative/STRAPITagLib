...
public class PublicHealthQuestionsCreatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(PublicHealthQuestionsCreatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			thePublicHealthQuestions.setCreatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing PublicHealthQuestions for createdAt tag ");
