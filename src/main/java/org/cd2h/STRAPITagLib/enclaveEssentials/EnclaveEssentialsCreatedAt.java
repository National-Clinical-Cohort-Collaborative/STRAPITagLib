...
public class EnclaveEssentialsCreatedAt extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(EnclaveEssentialsCreatedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			if (!theEnclaveEssentials.commitNeeded) {
				pageContext.getOut().print(theEnclaveEssentials.getCreatedAt());
			}
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing EnclaveEssentials for createdAt tag ");
	...
	public void setCreatedAt(Timestamp createdAt) throws JspException {
		try {
			EnclaveEssentials theEnclaveEssentials = (EnclaveEssentials)findAncestorWithClass(this, EnclaveEssentials.class);
			theEnclaveEssentials.setCreatedAt(createdAt);
		} catch (Exception e) {
			log.error("Can't find enclosing EnclaveEssentials for createdAt tag ", e);
			freeConnection();
			Tag parent = getParent();
