...
public class WorkstreamInstancesPublishedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(WorkstreamInstancesPublishedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theWorkstreamInstances.setPublishedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing WorkstreamInstances for publishedAt tag ");
