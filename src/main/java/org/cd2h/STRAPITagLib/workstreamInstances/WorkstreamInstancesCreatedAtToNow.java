...
public class WorkstreamInstancesCreatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(WorkstreamInstancesCreatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theWorkstreamInstances.setCreatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing WorkstreamInstances for createdAt tag ");
