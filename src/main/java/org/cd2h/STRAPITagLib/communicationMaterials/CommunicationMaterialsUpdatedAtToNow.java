...
public class CommunicationMaterialsUpdatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(CommunicationMaterialsUpdatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theCommunicationMaterials.setUpdatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing CommunicationMaterials for updatedAt tag ");
