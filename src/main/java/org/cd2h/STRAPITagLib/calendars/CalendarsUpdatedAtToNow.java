...
public class CalendarsUpdatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(CalendarsUpdatedAtToNow.class);


	public int doStartTag() throws JspException {
		try {
			Calendars theCalendars = (Calendars)findAncestorWithClass(this, Calendars.class);
			theCalendars.setUpdatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing Calendars for updatedAt tag ");
