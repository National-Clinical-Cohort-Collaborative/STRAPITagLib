...
public class ContentImageBlockRightsUpdatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(ContentImageBlockRightsUpdatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theContentImageBlockRights.setUpdatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing ContentImageBlockRights for updatedAt tag ");
