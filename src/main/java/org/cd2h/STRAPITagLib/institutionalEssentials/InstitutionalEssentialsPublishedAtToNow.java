...
public class InstitutionalEssentialsPublishedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(InstitutionalEssentialsPublishedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theInstitutionalEssentials.setPublishedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing InstitutionalEssentials for publishedAt tag ");
