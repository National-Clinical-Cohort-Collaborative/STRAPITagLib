...
public class InstitutionalEssentialsCreatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(InstitutionalEssentialsCreatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theInstitutionalEssentials.setCreatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing InstitutionalEssentials for createdAt tag ");
