...
public class STRAPITagLibBodyTagSupport extends BodyTagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;

    public STRAPITagLibBodyTagSupport() {
        super();
    }

    private static final Logger log = LogManager.getLogger(STRAPITagLibBodyTagSupport.class);
    ...
    public DataSource getDataSource() {
        if (theDataSource == null) try {
            theDataSource = (DataSource)new InitialContext().lookup("java:/comp/env/jdbc/STRAPITagLib");
        } catch (Exception e) {
