...
public class ContentImageBlockLeftsCreatedAtToNow extends STRAPITagLibTagSupport {

	private static final Logger log = LogManager.getLogger(ContentImageBlockLeftsCreatedAtToNow.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			theContentImageBlockLefts.setCreatedAtToNow( );
		} catch (Exception e) {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Can't find enclosing ContentImageBlockLefts for createdAt tag ");
